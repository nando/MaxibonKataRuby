# MaxibonKataRuby
![Karumi logo][karumilogo] Kata Maxibon for Ruby. [![Build Status](https://travis-ci.org/Karumi/MaxibonKataRuby.svg?branch=master)](https://travis-ci.org/Karumi/MaxibonKataRuby)
==================================================
